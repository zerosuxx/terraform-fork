...
func (*ListResource_Event_Result) Descriptor() ([]byte, []int) {
	return file_tfplugin6_proto_rawDescGZIP(), []int{34, 1, 0}
}
...
var file_tfplugin6_proto_rawDesc = string([]byte{
	...
	0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x36, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65,
	...
	0x4e, 0x10, 0x01, 0x32, 0xc1, 0x13, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72,
	...
	0x1f, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x36, 0x2e, 0x4c, 0x69, 0x73, 0x74,
	0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x1d, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x36, 0x2e, 0x4c, 0x69, 0x73,
	...
	0x20, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x36, 0x2e, 0x47, 0x65, 0x74, 0x46,
	...
	0x6e, 0x12, 0x1f, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x36, 0x2e, 0x43, 0x61,
	0x6c, 0x6c, 0x46, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x20, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x36, 0x2e, 0x43,
	0x61, 0x6c, 0x6c, 0x46, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x51, 0x0a, 0x0c, 0x53, 0x74, 0x6f, 0x70, 0x50, 0x72, 0x6f, 0x76,
	0x69, 0x64, 0x65, 0x72, 0x12, 0x1f, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x36,
	...
	0x61, 0x6c, 0x2f, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x36, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
})
...
var file_tfplugin6_proto_goTypes = []any{
	...
	(*ListResource_Event_Result)(nil),                // 109: tfplugin6.ListResource.Event.Result
	(*ValidateListResourceConfig_Request)(nil),       // 110: tfplugin6.ValidateListResourceConfig.Request
	(*ValidateListResourceConfig_Response)(nil),      // 111: tfplugin6.ValidateListResourceConfig.Response
...
var file_tfplugin6_proto_depIdxs = []int32{
	...
	109, // 125: tfplugin6.ListResource.Event.result:type_name -> tfplugin6.ListResource.Event.Result
	6,   // 126: tfplugin6.ListResource.Event.diagnostic:type_name -> tfplugin6.Diagnostic
	12,  // 127: tfplugin6.ListResource.Event.Result.identity:type_name -> tfplugin6.ResourceIdentityData
	5,   // 128: tfplugin6.ListResource.Event.Result.resource_object:type_name -> tfplugin6.DynamicValue
	5,   // 129: tfplugin6.ValidateListResourceConfig.Request.config:type_name -> tfplugin6.DynamicValue
	6,   // 130: tfplugin6.ValidateListResourceConfig.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	52,  // 131: tfplugin6.Provider.GetMetadata:input_type -> tfplugin6.GetMetadata.Request
	59,  // 132: tfplugin6.Provider.GetProviderSchema:input_type -> tfplugin6.GetProviderSchema.Request
	66,  // 133: tfplugin6.Provider.ValidateProviderConfig:input_type -> tfplugin6.ValidateProviderConfig.Request
	75,  // 134: tfplugin6.Provider.ValidateResourceConfig:input_type -> tfplugin6.ValidateResourceConfig.Request
	77,  // 135: tfplugin6.Provider.ValidateDataResourceConfig:input_type -> tfplugin6.ValidateDataResourceConfig.Request
	68,  // 136: tfplugin6.Provider.UpgradeResourceState:input_type -> tfplugin6.UpgradeResourceState.Request
	70,  // 137: tfplugin6.Provider.GetResourceIdentitySchemas:input_type -> tfplugin6.GetResourceIdentitySchemas.Request
	73,  // 138: tfplugin6.Provider.UpgradeResourceIdentity:input_type -> tfplugin6.UpgradeResourceIdentity.Request
	81,  // 139: tfplugin6.Provider.ConfigureProvider:input_type -> tfplugin6.ConfigureProvider.Request
	83,  // 140: tfplugin6.Provider.ReadResource:input_type -> tfplugin6.ReadResource.Request
	85,  // 141: tfplugin6.Provider.PlanResourceChange:input_type -> tfplugin6.PlanResourceChange.Request
	87,  // 142: tfplugin6.Provider.ApplyResourceChange:input_type -> tfplugin6.ApplyResourceChange.Request
	89,  // 143: tfplugin6.Provider.ImportResourceState:input_type -> tfplugin6.ImportResourceState.Request
	92,  // 144: tfplugin6.Provider.MoveResourceState:input_type -> tfplugin6.MoveResourceState.Request
	94,  // 145: tfplugin6.Provider.ReadDataSource:input_type -> tfplugin6.ReadDataSource.Request
	79,  // 146: tfplugin6.Provider.ValidateEphemeralResourceConfig:input_type -> tfplugin6.ValidateEphemeralResourceConfig.Request
	96,  // 147: tfplugin6.Provider.OpenEphemeralResource:input_type -> tfplugin6.OpenEphemeralResource.Request
	98,  // 148: tfplugin6.Provider.RenewEphemeralResource:input_type -> tfplugin6.RenewEphemeralResource.Request
	100, // 149: tfplugin6.Provider.CloseEphemeralResource:input_type -> tfplugin6.CloseEphemeralResource.Request
	107, // 150: tfplugin6.Provider.ListResource:input_type -> tfplugin6.ListResource.Request
	110, // 151: tfplugin6.Provider.ValidateListResourceConfig:input_type -> tfplugin6.ValidateListResourceConfig.Request
	102, // 152: tfplugin6.Provider.GetFunctions:input_type -> tfplugin6.GetFunctions.Request
	105, // 153: tfplugin6.Provider.CallFunction:input_type -> tfplugin6.CallFunction.Request
	42,  // 154: tfplugin6.Provider.StopProvider:input_type -> tfplugin6.StopProvider.Request
	53,  // 155: tfplugin6.Provider.GetMetadata:output_type -> tfplugin6.GetMetadata.Response
	60,  // 156: tfplugin6.Provider.GetProviderSchema:output_type -> tfplugin6.GetProviderSchema.Response
	67,  // 157: tfplugin6.Provider.ValidateProviderConfig:output_type -> tfplugin6.ValidateProviderConfig.Response
	76,  // 158: tfplugin6.Provider.ValidateResourceConfig:output_type -> tfplugin6.ValidateResourceConfig.Response
	78,  // 159: tfplugin6.Provider.ValidateDataResourceConfig:output_type -> tfplugin6.ValidateDataResourceConfig.Response
	69,  // 160: tfplugin6.Provider.UpgradeResourceState:output_type -> tfplugin6.UpgradeResourceState.Response
	71,  // 161: tfplugin6.Provider.GetResourceIdentitySchemas:output_type -> tfplugin6.GetResourceIdentitySchemas.Response
	74,  // 162: tfplugin6.Provider.UpgradeResourceIdentity:output_type -> tfplugin6.UpgradeResourceIdentity.Response
	82,  // 163: tfplugin6.Provider.ConfigureProvider:output_type -> tfplugin6.ConfigureProvider.Response
	84,  // 164: tfplugin6.Provider.ReadResource:output_type -> tfplugin6.ReadResource.Response
	86,  // 165: tfplugin6.Provider.PlanResourceChange:output_type -> tfplugin6.PlanResourceChange.Response
	88,  // 166: tfplugin6.Provider.ApplyResourceChange:output_type -> tfplugin6.ApplyResourceChange.Response
	91,  // 167: tfplugin6.Provider.ImportResourceState:output_type -> tfplugin6.ImportResourceState.Response
	93,  // 168: tfplugin6.Provider.MoveResourceState:output_type -> tfplugin6.MoveResourceState.Response
	95,  // 169: tfplugin6.Provider.ReadDataSource:output_type -> tfplugin6.ReadDataSource.Response
	80,  // 170: tfplugin6.Provider.ValidateEphemeralResourceConfig:output_type -> tfplugin6.ValidateEphemeralResourceConfig.Response
	97,  // 171: tfplugin6.Provider.OpenEphemeralResource:output_type -> tfplugin6.OpenEphemeralResource.Response
	99,  // 172: tfplugin6.Provider.RenewEphemeralResource:output_type -> tfplugin6.RenewEphemeralResource.Response
	101, // 173: tfplugin6.Provider.CloseEphemeralResource:output_type -> tfplugin6.CloseEphemeralResource.Response
	108, // 174: tfplugin6.Provider.ListResource:output_type -> tfplugin6.ListResource.Event
	111, // 175: tfplugin6.Provider.ValidateListResourceConfig:output_type -> tfplugin6.ValidateListResourceConfig.Response
	103, // 176: tfplugin6.Provider.GetFunctions:output_type -> tfplugin6.GetFunctions.Response
	106, // 177: tfplugin6.Provider.CallFunction:output_type -> tfplugin6.CallFunction.Response
	43,  // 178: tfplugin6.Provider.StopProvider:output_type -> tfplugin6.StopProvider.Response
	155, // [155:179] is the sub-list for method output_type
	131, // [131:155] is the sub-list for method input_type
